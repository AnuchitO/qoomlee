      ...
      <main className="flex min-h-[calc(100vh-4rem)] flex-col items-center justify-between p-24">
        <div className="z-10 w-full max-w-5xl items-center justify-between font-mono text-sm lg:flex">
          <div className="fixed bottom-0 left-0 flex h-48 w-full items-end justify-center bg-gradient-to-t from-white via-white dark:from-black dark:via-black lg:static lg:size-auto lg:bg-none">
            <Link
              ...
              href="https://qoomlee-airline.vercel.app"
              target="_blank"
              rel="noopener noreferrer"
            >
              <span className="text-xl font-bold">Qoomlee Airline</span>
            </Link>
          </div>
        </div>
        ...
        <div className="mb-32 grid text-center lg:mb-0 lg:w-full lg:max-w-5xl lg:grid-cols-4">
          ...
          >
            ...
            <p className="m-0 max-w-[30ch] text-sm opacity-50">
              View, modify, or cancel your booking
            </p>
          </Link>
